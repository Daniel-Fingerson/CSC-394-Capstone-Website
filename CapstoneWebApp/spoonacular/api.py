...
class API(object):
    ...
    def ingredientWidget(self, id, defaultCss=None):
        """ Visualize a recipe's nutrition data.
            https://spoonacular.com/food-api/docs#visualize-recipe-nutrition-by-id
        """
        endpoint = "recipes/{id}/ingredientWidget".format(id=id)
        url_query = {}
        url_params = {"defaultCss":"true", "showBacklink":"false"}
        return self._make_request(endpoint, method="GET", query_=url_query, params_=url_params)

    def equipmentWidget(self, id, defaultCss=None):
        """ Visualize a recipe's nutrition data.
            https://spoonacular.com/food-api/docs#visualize-recipe-nutrition-by-id
        """
        endpoint = "recipes/{id}/equipmentWidget".format(id=id)
        url_query = {}
        url_params = {"defaultCss":"true", "showBacklink":"false"}
        return self._make_request(endpoint, method="GET", query_=url_query, params_=url_params)
    ...
    def singleIngredientWidget(self, id, defaultCss=None):
        """ Visualize a recipe's nutrition data.
            https://spoonacular.com/food-api/docs#visualize-recipe-nutrition-by-id
        """
        endpoint = "food/products/{id}/nutritionWidget".format(id=id)
        url_query = {}
        url_params = {"defaultCss":"true", "showBacklink":"false"}
        return self._make_request(endpoint, method="GET", query_=url_query, params_=url_params)
